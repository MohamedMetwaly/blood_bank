...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('admin/')}}" class="logo">
      ...
      <span class="logo-mini"><b>بنك</b>الدم</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>بنك</b>الدم</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
          <li><a href="{{url(route('governorate.index'))}}"><i class="fa fa-book"></i> <span>المحافظات</span></a></li>
          <li><a href="{{url(route('city.index'))}}"><i class="fa fa-book"></i> <span>المدن</span></a></li>
          <li><a href="{{url(route('category.index'))}}"><i class="fa fa-book"></i> <span>الفئات</span></a></li>
          <li><a href="{{url(route('post.index'))}}"><i class="fa fa-book"></i> <span>المنشورات</span></a></li>
          <li><a href="{{url(route('donation.index'))}}"><i class="fa fa-book"></i> <span>طلبات التبرع</span></a></li>
          <li><a href="{{url(route('client.index'))}}"><i class="fa fa-book"></i> <span>العملاء</span></a></li>
          <li><a href="{{url(route('user.index'))}}"><i class="fa fa-book"></i> <span>المستخدمين</span></a></li>
          <li><a href="{{url(route('changePassword'))}}"><i class="fa fa-book"></i> <span>تغيير كلمه المرور</span></a></li>
          <li><a href="{{url(route('role.index'))}}"><i class="fa fa-book"></i> <span>رتب المستخدمين</span></a></li>
          <li><a href="{{url(route('contact.index'))}}"><i class="fa fa-book"></i> <span>تواصل</span></a></li>
        <li><a href="{{url(route('setting.index'))}}"><i class="fa fa-book"></i> <span>اعدادات الموقع</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
