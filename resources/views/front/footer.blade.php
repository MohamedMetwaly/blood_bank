...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="footer-logo" src="{{asset('public/client/imgs/logo.png')}}">
                <p class="footer-text">{{$settings->about_app}}</p>
            </div>
            <div class="col-md-4">
                <ul class="footer-list">
                    <a href="{{url(route('homepage'))}}"><li> الرئيسيه</li></a>
                    <a href="{{url('user/articles')}}"> <li> المقالات </li></a>
                    <a href="{{url('user/donations')}}"><li> طلبات التبرع </li></a>
                    <a href="{{url('user/about')}}"> <li> من نحن </li></a>
                    <a href="{{url('user/contact')}}">  <li> اتصل بنا </li></a>

                </ul>
            </div>
            <div class="col-md-4 change-position">
                <p class="footer-subtext">مـتــوفر علي </p>
                <img class="footer-android" src="{{asset('public/client/imgs/google1.png')}}">
                <img class="footer-ios" src="{{asset('public/client/imgs/ios1.png')}}">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="social-media">
                    ...
                    <a href="{{$settings->google_link}}" target="_blank"><i class="fab fa-google hvr-float"></i></a>
