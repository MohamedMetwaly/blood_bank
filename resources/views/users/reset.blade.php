...
{{--                    @enderror--}}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                    <input id="password-confirm" type="password-confirm" class="form-control @error('password-confirm') is-invalid @enderror" name="password-confirm" required autocomplete="password-confirm" autofocus>
